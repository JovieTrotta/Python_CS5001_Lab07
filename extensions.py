...
There are five options accessed via the main menu: Psychadelic Boxes, Bull's Eye, Turning Spiral, Box Tree, Cherry Blossom Tree, and Sunbeam.
'''
...
'''
Function that creates a realistic looking cherry blossom tree
...
'''
Function that creates a sunbeam pattern using recursive lines
Parameters: three integers
Returning: a pattern using lines
'''
def sunbeam(x,y,lineLen):
    t.setup(1000,1000)
    t.speed(0)
    ...
    # Decreases line length by 2
    lineLen -= 2

    # Recursive step begins
    # If the length of the line is greater than or equal to zero, execute next step
    if lineLen >= 0:

        # Draws the line again with the new lineLen value
        sunbeam(x,y,lineLen)
...
def menu():
    ...
    print("...5 for Cherry Blossom Tree.")
    print("...6 for Sunbeam.")
    print("...7 to clear the window.")
    ...
    while True:
        ...
        if menu_choice == "1":
            ...
            print("You have selected Cherry Blossom Tree.")
        elif menu_choice == "6":
            sunbeam(int(input("What is the x value?\n")),int(input("What is the y value?\n")),abs(int(input("What is the line length?\n"))))
            print("You have selected Box Tree.")
        elif menu_choice == "7":
