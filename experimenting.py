...
There are five options accessed via the main menu: Psychadelic Boxes, Bull's Eye, Turning Spiral, Box Tree, and Cherry Blossom Tree.
'''
...
def menu():
    ...
    while True:
        ...
        if menu_choice == "1":
            ...
            t.done
            #t.Screen.getMouse()
            WN.onclick(reset_turtle())
            #t.Screen(t.onclick(reset_turtle()))
        elif menu_choice == "2":
            ...
            print("Your options are 1, 2, 3, 4, 5, or 0.")
